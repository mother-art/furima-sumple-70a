...
//     const html = `<img data_index="${index}" src="${url}" width="100px" height="100px">`;
//     return html;
//   }


//   const buildFileField = (index)=> {
//     const html = `<div data_index="${index}" class="js-file_group">
//                     <input class="js-file" type="file"
//                     name="product[item_images_attributes][${index}][image]"
